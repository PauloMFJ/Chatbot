...
class Booking(KnowledgeEngine):
    ...
    def predict_delay(self):
        predict_delay(self.knowledge.get('predictFromLocation'), 
            self.knowledge.get('predictToLocation'), 
            self.knowledge.get('predictDepartTime'), 
            self.knowledge.get('predictReturnTime'), 
            self.knowledge.get('predictDelay'))
